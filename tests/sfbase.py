...
class SFBaseTest(BaseCase):
    ...
    def expected_metadata():
        ...
        return {
            ...
            'ConvMessageSendRequest': incremental_last_modified,
            'AppointmentInvitationFeed': incremental_last_modified,
            'EngagementChannelWorkType': incremental_last_modified,
            'PromotionLineItemRule': incremental_last_modified,
            'ShippingCarrier': incremental_last_modified,
            'MLModelMetric': incremental_last_modified,
            'PromotionTierHistory': incremental_last_modified,
            'IncidentRelatedItemHistory': incremental_last_modified,
            'ShippingRateGroup': incremental_last_modified,
            'ExternalDataSrcDescriptor': incremental_last_modified,
            'WaitlistWorkType': incremental_last_modified,
            'PrivacyJobSessionShare': incremental_last_modified,
            'ReplyEmailSettings': incremental_last_modified,
            'ProblemRelatedItemHistory': incremental_last_modified,
            'AppointmentInvitationHistory': incremental_last_modified,
            'FlowRecordVersionOccurrence': incremental_last_modified,
            'ChangeRequest': incremental_last_modified,
            'MsgChannelUsageExternalOrg': incremental_last_modified,
            'ManagedContentVariant': incremental_last_modified,
            'FlowOrchestrationStepInstance': incremental_last_modified,
            'SellerShare': incremental_last_modified,
            'PrivacyJobSession': incremental_last_modified,
            'WaitlistServiceResource': incremental_last_modified,
            'FlowOrchestrationStepInstanceShare': incremental_last_modified,
            'FlowRecordVersion': incremental_last_modified,
            'ScorecardMetric': incremental_last_modified,
            'ChangeRequestRelatedItemFeed': incremental_last_modified,
            'UserDefinedLabelAssignmentShare': incremental_last_modified,
            'ProblemRelatedItem': incremental_last_modified,
            'GuestUserAnomalyEventStoreFeed': incremental_last_modified,
            'EngagementChannelWorkTypeFeed': incremental_last_modified,
            'SkillType': incremental_last_modified,
            'InventoryReservationShare': incremental_last_modified,
            'Problem': incremental_last_modified,
            'AppointmentInvitationShare': incremental_last_modified,
            'ChatRetirementRdyMetrics': incremental_last_modified,
            'BusinessBrandShare': incremental_last_modified,
            'SellerHistory': incremental_last_modified,
            'AppointmentCategoryFeed': incremental_last_modified,
            'ProblemIncidentFeed': incremental_last_modified,
            'ShippingConfigurationSet': incremental_last_modified,
            'MLModel': incremental_last_modified,
            'WaitlistWorkTypeHistory': incremental_last_modified,
            'ShippingCarrierFeed': incremental_last_modified,
            'PromotionSegmentBuyerGroupFeed': incremental_last_modified,
            'PrivacySessionRecordFailure': incremental_last_modified,
            'ContractLineItemFeed': incremental_last_modified,
            'ContextParamMap': incremental_last_modified,
            'FlowOrchestrationInstance': incremental_last_modified,
            'ActivityFieldHistory': default_full,
            'EngagementChannelWorkTypeHistory': incremental_last_modified,
            'WaitlistParticipantHistory': incremental_last_modified,
            'WebCartAdjustmentBasis': incremental_last_modified,
            'ScorecardAssociation': incremental_last_modified,
            'ShippingConfigurationSetShare': incremental_last_modified,
            'PromotionQualifierFeed': incremental_last_modified,
            ...
            'ShippingCarrierMethodHistory': incremental_last_modified,
            'PrivacyRTBFRequestHistory': incremental_last_modified,
            'TableauHostMapping': incremental_last_modified,
            'AppointmentInvitation': incremental_last_modified,
            'PipelineInspectionListView': incremental_last_modified,
            'PromotionTier': incremental_last_modified,
            'ServiceAppointmentAttendeeHistory': incremental_last_modified,
            'ProcessFlowMigration': incremental_last_modified,
            'ServiceAppointmentAttendeeShare': incremental_last_modified,
            'Scorecard': incremental_last_modified,
            'ManagedContent': incremental_last_modified,
            'ChangeRequestRelatedItem': incremental_last_modified,
            'ShiftEngagementChannelFeed': incremental_last_modified,
            'EventRelayFeedback': incremental_last_modified,
            'CaseRelatedIssueFeed': incremental_last_modified,
            'ChangeRequestRelatedIssueHistory': incremental_last_modified,
            'Incident': incremental_last_modified,
            'EngmtChannelTypeSettings': incremental_last_modified,
            'PrivacyRTBFRequestShare': incremental_last_modified,
            'IncidentRelatedItemFeed': incremental_last_modified,
            'ProblemHistory': incremental_last_modified,
            'ChangeRequestRelatedIssueFeed': incremental_last_modified,
            'CouponFeed': incremental_last_modified,
            'WaitlistWorkTypeFeed': incremental_last_modified,
            'GuestUserAnomalyEventStore': incremental_last_modified,
            'AppointmentCategoryHistory': incremental_last_modified,
            'OauthTokenExchHandlerApp': incremental_last_modified,
            'FlowOrchestrationWorkItem': incremental_last_modified,
            'CouponCodeRedemption': incremental_last_modified,
            'PromotionTierFeed': incremental_last_modified,
            'ExpressionSetView': incremental_last_modified,
            'OpportunityRelatedDeleteLog': incremental_last_modified,
            'ShippingCarrierHistory': incremental_last_modified,
            'ShippingCarrierMethodFeed': incremental_last_modified,
            'ChangeRequestRelatedIssue': incremental_last_modified,
            'WaitlistShare': incremental_last_modified,
            'Customer': incremental_last_modified,
            'EventRelayConfig': incremental_last_modified,
            'ShippingCarrierMethodShare': incremental_last_modified,
            'PrivacyPolicyDefinition': incremental_last_modified,
            'ProblemFeed': incremental_last_modified,
            'FlowRecordElement': incremental_last_modified,
            'ProblemRelatedItemFeed': incremental_last_modified,
            'AssignedResourceHistory': incremental_last_modified,
            'UserPrioritizedRecord': incremental_last_modified,
            'CaseRelatedIssueHistory': incremental_last_modified,
            'FlowOrchestrationInstanceShare': incremental_last_modified,
            'FlowOrchestrationLog': incremental_last_modified,
            'OauthTokenExchangeHandler': incremental_last_modified,
            'BrowserPolicyViolation': incremental_last_modified,
            'WaitlistServiceResourceHistory': incremental_last_modified,
            'WaitlistHistory': incremental_last_modified,
            'WaitlistServiceResourceFeed': incremental_last_modified,
            'ShippingRateArea': incremental_last_modified,
            'Seller': incremental_last_modified,
            'ServiceAppointmentAttendee': incremental_last_modified,
            'PrivacyRTBFRequestFeed': incremental_last_modified,
            'WaitlistParticipantFeed': incremental_last_modified,
            'ChangeRequestShare': incremental_last_modified,
            'ChangeRequestHistory': incremental_last_modified,
            'CaseRelatedIssue': incremental_last_modified,
            'PendingOrderSummary': default_full,
            'Waitlist': incremental_last_modified,
            'CaseHistory2': incremental_last_modified,
            'AppointmentInvitee': incremental_last_modified,
            'Participant': incremental_last_modified,
            'UserDefinedLabelAssignment': incremental_last_modified,
            'ManagedContentSpace': incremental_last_modified,
            'ProblemIncidentHistory': incremental_last_modified,
            'PromotionSegmentFeed': incremental_last_modified,
            'ManagedContentChannel': incremental_last_modified,
            'ShippingCarrierMethod': incremental_last_modified,
            'PrivacySessionRecordFailureShare': incremental_last_modified,
            'InventoryReservation': incremental_last_modified,
            'PrivacyRTBFRequest': incremental_last_modified,
            'UserDefinedLabelShare': incremental_last_modified,
            'FileEventStore': default_full,
            'WebStoreInventorySource': incremental_last_modified,
            'FlowTestResult': incremental_last_modified,
            'IncidentRelatedItem': incremental_last_modified,
            'PromotionSegmentSalesStoreFeed': incremental_last_modified,
            'ScorecardShare': incremental_last_modified,
            'WaitlistFeed': incremental_last_modified,
            'PrivacyObjectSessionShare': incremental_last_modified,
            'ShiftWorkTopicHistory': incremental_last_modified,
            'CouponCodeRedemptionShare': incremental_last_modified,
            'PrivacyPolicy': incremental_last_modified,
            'ShiftEngagementChannelHistory': incremental_last_modified,
            'IncidentHistory': incremental_last_modified,
            'OrgEmailAddressSecurity': incremental_last_modified,
            'ShippingCarrierShare': incremental_last_modified,
            'UserDefinedLabel': incremental_last_modified,
            'MessagingChannelUsage': incremental_last_modified,
            'IncidentFeed': incremental_last_modified,
            'TableauHostMappingShare': incremental_last_modified,
            'ShiftWorkTopic': incremental_last_modified,
            'ChangeRequestRelatedItemHistory': incremental_last_modified,
            'MLRecommendationDefinition': incremental_last_modified,
            'PaymentFeed': incremental_last_modified,
            'MLModelFactorComponent': incremental_last_modified,
            'ChangeRequestFeed': incremental_last_modified,
            'MLModelFactor': incremental_last_modified,
            'InventoryItemReservation': incremental_last_modified,
            'PromotionTargetFeed': incremental_last_modified,
            'ShiftEngagementChannel': incremental_last_modified,
            'ProblemIncident': incremental_last_modified,
            'DataKitDeploymentLog': incremental_last_modified,
            'ShiftWorkTopicFeed': incremental_last_modified,
            'FlowRecordShare': incremental_last_modified,
            'IncidentShare': incremental_last_modified,
            'AppointmentCategory': incremental_last_modified,
            'StandardShippingRate': incremental_last_modified,
            'MlFeatureValueMetric': incremental_last_modified,
            'DataKitDeploymentLogShare': incremental_last_modified,
            'FlowOrchestrationWorkItemShare': incremental_last_modified,
            'DataWeaveResource': incremental_last_modified,
            'ExternalEncryptionRootKey': default_full,
            'ServiceAppointmentAttendeeFeed': incremental_last_modified,
            'FlowOrchestrationStageInstance': incremental_last_modified
        }
